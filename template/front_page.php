                        ...
                        <section class="cards">
                            ...
                            while ($loop->have_posts()) : $loop->the_post();
                                ...
                                if (has_post_thumbnail()) {
                                    ...
                                    $default = get_theme_file_uri('/img/default-fimg.gif');
                                    echo '<img src="' . $default . '" class="attachment-post-thumbnail 
                                                size-post-thumbnail wp-post-image" alt="">';
                                }
                                echo '</div>';
                                echo '<div class="card-title">';
                                echo the_title();
                                echo '</div><div class="card-text">';
                               // echo the_excerpt();
                                echo '</div>';
                                echo '</a>';
                            endwhile;
                ...
                <div id="social" class="trans_row">
                    ...
                    <div id="fb_social" class="social_col">
                        <span class="social-title"><a target="_blank"
                                                      href="https://www.facebook.com/VenusdeMarsandAllThePrettyHorses/">Facebook</a></span><br/>
